...
class ActiveField extends \yii\widgets\ActiveField {
    ...
    public function switchButton($options = []) {
        ...
        $size = ArrayHelper::getValue($options, 'size', "normal");
        Widgets::widgetSwitchButton($this->form->getView(), $options['id'], $size);
    ...
    public function colorPicker($options = []) {
        ...
        Widgets::widgetColorpicker($this->form->getView(), $options['id']);
    ...
    public function select($items, $options = []) {
        ...
        Widgets::widgetSelect($this->form->view, $options['id']);
        return $this;
    }

    public function enhancedselect($items, $options = []) {
        $options = array_merge($this->inputOptions, $options);
        $options['id'] = Html::getInputId($this->model, $this->attribute);
    ...
    public function inputMask($type, $format, $options = []) {
        $options['id'] = Html::getInputId($this->model, $this->attribute);

        parent::textInput($options);

        Widgets::widgetInputmask($this->form->getView(), $options['id'],$type,$format);
    ...
    public function timePicker($options = []) {
        ...
        Widgets::widgetTimePicker($this->form->getView(), $options['id']);
    ...
    public function datePicker($options=[]){
        ...
        $options['id'] = Html::getInputId($this->model, $this->attribute);
        parent::textInput($options);
        Widgets::widgetDatePicker($this->form->getView(), $options['id'],Html::getAttributeValue($this->model,$this->attribute));
    ...
    public function dateTimePicker($options=[]){
        ...
        $options['id'] = Html::getInputId($this->model, $this->attribute);
        parent::textInput($options);
        Widgets::widgetDateTimePicker($this->form->getView(), $options['id'],Html::getAttributeValue($this->model,$this->attribute));
